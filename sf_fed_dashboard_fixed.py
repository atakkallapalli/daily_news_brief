#!/usr/bin/env python3
"""
SF Fed Executive Dashboard - Fixed Version
...
# SF Fed Executive Dashboard Template with Executive Summary at Top
SF_FED_TEMPLATE = """
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="executive-summary">
            ...
            <div class="stats-bar">
                ...
                <div class="stat-item">
                    ...
                    <span class="stat-label">Priority Areas</span>
                </div>
            </div>
        </div>
    ...
    for i, line in enumerate(lines):
        ...
        if current_section and current_section != 'sf_fed_implications':
            ...
            # Regular content lines
                ...
                # Use the content as a single bullet point instead of creating 4 duplicates
                if len(current_article['bullets']) == 0:
                    current_article['bullets'] = [line.strip()]
        ...
        if isinstance(articles, list):
            ...
            for i, article in enumerate(articles[:2]):  # Show first 2 articles
                if isinstance(article, dict):
                    ...
                    print(f"       Bullets: {len(article.get('bullets', []))}")
